...
const Home = () => {
  ...
  // Watches_____________-
  useEffect(() => {
    fetch(`${import.meta.env.VITE_API_URL}/api/watches-get`)
      .then(response => response.json())
      .then(data => {
        setWatches(data);
      })
  ...
  return (
    ...
    <div className='bg-gradient-to-r from-pink-300 via-pink-100 to-pink-300 p-8'>
      <div className="container mx-auto">
        <h2 className="text-4xl font-extrabold text-center mb-12 text-slate-7 00">Sunglasses</h2>
        <div className="flex flex-wrap justify-between items-start">
          <div className="w-full md:w-1/4 p-4" data-aos="fade-right">
