        ...
        <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
          <div className="px-4 pt-8">
              ...
              {cartItems.length > 0 ? (
                cartItems.map((product) => (
                  <div key={product._id} className="flex flex-col rounded-lg bg-white sm:flex-row">
                    <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src={`${import.meta.env.VITE_API_URL}/${product.image}`} alt={product.name} />
            ...
            <form className="mt-5 grid gap-6">
              ...
              {/* <div className="relative">
                <input className="peer hidden" id="radio_2" type="radio" name="shippingMethod" value="Card Payment" checked={formData.shippingMethod === 'Card Payment'} onChange={handleChange} />
                <span className="peer-checked:border-gray-700 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white" />
          ...
          <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
            ...
            <div>
              ...
              <div className="mt-6 flex items-center justify-between">
                ...
                <p className="text-2xl font-semibold text-gray-900">Rs{(totalAmount + 300).toFixed(0)}</p>
              </div>
            </div>
